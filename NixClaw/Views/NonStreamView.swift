    ...
    ZStack {
      ...
      VStack {
        ...
        VStack(spacing: 12) {
          ...
          Text("Stream from your glasses, use your iPhone camera, or start an audio-only conversation.")
            .font(.system(size: 15))
  ...
  var body: some View {
    VStack(spacing: 24) {
      ...
      VStack(spacing: 12) {
        TipItemView(
          resource: .videoIcon,
          text: "First, NixClaw needs permission to use your glasses camera."
        )
        TipItemView(
          resource: .tapIcon,
